...
class GetNNPredicitons(object):
    def __init__(self):
        ...
        self.days = np.array(range(self.period, self.period + self.upcoming_days)).reshape(-1, 1)
        ...
        self.confirmed_states_pred_dict = get_pred(self, self.confirmed_states_model_list, "Confirmed")
        self.deaths_states_pred_dict = get_pred(self, self.deaths_states_model_list, "Deaths")
